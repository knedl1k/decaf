...
## repo structure
- **[thesis](thesis/)**
    - LaTeX source code of the thesis itself
- **[software](sw/)**
...
- **[scripts](scripts/)**
    - Various utilities, e.g., a script for downloading and preparing a dataset.
- **[research & sources](sources/)**
    - Collected materials, links to scientific articles (papers) and tutorials on algorithms.

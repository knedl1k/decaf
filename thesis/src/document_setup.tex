...
\usetikzlibrary{backgrounds,arrows.meta,automata,shapes,positioning,calc,through,spy,shapes,shapes.geometric,shapes.multipart,fit,patterns,fadings,angles,quotes}
...
\usepackage[backend=biber,defernumbers=true,style=ieee,sortcites=true]{biblatex}
...
%   \ifkeyword{crucial}{%
%     \begin{tcolorbox}[%
%       opacityfill=0.05, colback={cvutblue}, colframe={cvutblue}, 
%       nobeforeafter, width=\linewidth,
%       boxrule=0.5mm, boxsep=1mm, left=4mm, right=4mm, top=2mm, bottom=2mm%
%     ]%
%   }{%
%     \begin{tcolorbox}[%
%       colback=white, colframe=white, 
%       nobeforeafter, width=\linewidth,
%       boxrule=0mm, boxsep=0mm, left=5.5mm, right=5.5mm, top=0mm, bottom=0mm%
%     ]%
%   }%
%   % citation's number
%   \begin{minipage}[t]{0.07\linewidth}%
...
\definecolor{greenstring}{rgb}{0.13, 0.55, 0.13}
\definecolor{redcomment}{rgb}{0.75, 0.15, 0.15}
...
\lstset{
    ...
    escapeinside={(*@}{@*)},
    commentstyle=\color{redcomment},
    keywordstyle=\color{black},
    stringstyle=\color{greenstring},
    numberstyle=\color{linegray},
...
function get_total_cost()
    tex.print(string.format("%.2f", total_cost))
end
\end{luacode*}

\newcommand{\resetcost}{\directlua{total_cost = 0}}

\newcommand{\cost}[2][]{%
    #1#2%
    \directlua{add_cost([[#2]])}%
}

\newcommand{\totalcost}{\directlua{get_total_cost()}}

%% | ----------- Pseudocode & Algorithms ----------- |
% Source - https://tex.stackexchange.com/a/721412
% Posted by Paulo

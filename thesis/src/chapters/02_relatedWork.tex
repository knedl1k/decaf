...
Recent academic work has focused on the pipeline of locating objects and manipulating them.
...
\section{Summary}
While current commercial solutions, such as \ii{CardBot}, offer robust hardware, they remain inaccessible due to high costs and closed ecosystems. In contrast, academic research provides the fundamental building blocks: \ac{YOLO} for detection \cite{pokerrobot}, synthetic data for training \cite{pokemonstanford}, and Siamese networks for identification \cite{lowhuryugioh}. However, it rarely integrates them into a complete open-source device, let alone into easily reproducible learning material for enthusiasts.

...
\begin{itemize}
    ...
    \item \bb{Magic Sorter:} \ii{Magic Sorter} \cite{magicsorter} offers a more compact alternative, focusing specifically on \ac{MTG} cards. It integrates a feeder mechanism with a custom software suite, demonstrating the tight coupling between hardware and proprietary databases common in commercial tools.
\end{itemize}

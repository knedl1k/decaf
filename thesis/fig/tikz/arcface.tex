...
\definecolor{marginGray}{RGB}{220, 220, 220}
	...
	\begin{figure}[H]
	    ...
	    \caption{Geometric interpretation of Softmax vs. \ac{arcface}. (a) Softmax creates linear boundaries without intra-class compactness. (b) \ac{arcface} projects features onto a hypersphere and enforces an angular margin $m$, creating a clear gap between classes.}

...
\begin{frame}{Hardware: Concept}
    \begin{itemize}
        ...
        \item \bb{Milestone reached:} Precise stepper motor control using rotation encoders feedback loop.
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.58\textwidth]{../../robotic-arm_cards.pdf}
    \end{center}
\end{frame}
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item \bb{Geometric:} Random perspective, rotation.
                \item \bb{Photometric:} Blur, noise, lighting conditions, partial occlusions.
            \end{itemize}
        \end{column}
    \end{columns}
    \vspace{1.5em}
